...
signals:
    void newCenter(Character* center);
private:
    bool ice_shooting;
};

class Bullet_Ice :public Bullet_Distance
{
public:
    Bullet_Ice(QString img, int radius, Character* center, int distance, double x=0,double y=0,double xv=0,double yv=0,double xa=0,double ya=0);
};
