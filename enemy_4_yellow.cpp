...
:Enemy_4(QString(":/res/enemy18.png"),200,153,std::round(3.902*radius),3*radius,player,health,radius,shoot_cd,shoot_cd_init,x,y,xv,yv,xa,ya,bounceable,stopable)
{
    move_speed=0.4;
    setInvulnerable();
}
