...
Effect::Effect(int pixmap, int img_w, int img_h, int show_w, int show_h, int lifetime, double x, double y, double xv, double yv, double xa, double ya, bool autoFadeoutBeforeDie)
    :Character(pixmap, img_w, img_h, show_w, show_h, 1, 0, x, y, xv, yv, xa, ya)
{
...
Effect::Effect(const QString &img, int img_w, int img_h, int show_w, int show_h, int lifetime, double x, double y, double xv, double yv, double xa, double ya, bool autoFadeoutBeforeDie)
...
void Effect::move() {
    ...
    if(rotating) {
        ...
        setRotation(this->rotation()+360.0/rotate_t);
    }
